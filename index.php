        ...
        <div class="row">
                    ...
                    ?>
                        <div class="col-md-6">
                            <div class="card card-shoes me-2 mt-2">
                                <img src="<?= $brand['imgBrand'] ?>" title="<?= $brand['name'] ?>" style="max-width: 240px; max-height: 152px; border: none;">
                            </div>
                        </div>
                    <?php
                    endforeach;
            ...
            <div class="col-6" style="margin: auto;">
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="./template/images/Carousel1.webp" style="max-width: 900px; max-height: 900px;" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./template/images/Carousel2.webp" style="max-width: 900px; max-height: 900px;" class="d-block w-100" alt="...">
                        </div>
                    </div>
